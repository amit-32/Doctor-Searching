...
<html>
    <head>
        ...
        <title>Doctor's Forget Password</title>
    </head>
    <body>
        <%
            try {
                ...
                if (name != null && mob != null && fname != null && !name.isEmpty() && !mob.isEmpty() && !fname.isEmpty()) {
                    ...
                    String sql = "SELECT * FROM doctor WHERE username = ? AND mobileno = ? AND security_q = ?";
                    ...
                    if (resultSet.next()) {
                        ...
                        response.sendRedirect("docpassupdate.html?mobile=" + mob);
                    } else {
